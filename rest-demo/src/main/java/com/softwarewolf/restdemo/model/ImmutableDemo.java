...
public class ImmutableDemo {
    ...
    public ImmutableDemo(String id, String title, String description, String url, LocalDateTime startDate, LocalDateTime endDate) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        ImmutableDemo that = (ImmutableDemo) o;
